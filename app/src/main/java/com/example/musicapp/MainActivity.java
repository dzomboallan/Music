...
public class MainActivity extends AppCompatActivity implements songChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int nextSongListPostion = currentSongPosition + 1;

                if (nextSongListPostion >= musicLists.size()){
                    nextSongListPostion = 0;
                }
        ...
        prevBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int prevSongListPostion = currentSongPosition - 1;

                if (prevSongListPostion < 0){
                    prevSongListPostion = musicLists.size() -1;
                }
    ...
    public void onChanged(int position) {
        ...
        mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                String generateDuration = String.format(Locale.getDefault(), "%02d:%02d", TimeUnit
                        .MILLISECONDS.toMinutes(getTotalDuration), TimeUnit.MILLISECONDS.toSeconds(getTotalDuration)
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String generateDuration = String.format(Locale.getDefault(), "%02d:%02d", TimeUnit
                                .MILLISECONDS.toMinutes(getCurrentDuration), TimeUnit.MILLISECONDS.toSeconds(getCurrentDuration)
